        ...
        <div class="page">
                ...
                <div class="rd-navbar-main-outer">
                  <div class="rd-navbar-main">
                    ...
                    <div class="rd-navbar-panel">
                      ...
                      {/* <!-- RD Navbar Brand--> */}
                      <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-200x45.png" alt="" width="200" height="45" /><img class="brand-logo-light" src="images/logo-105x51.png" alt="" width="105" height="51" /></a>
                      </div>
                    </div>
          ...
          <section class="section swiper-container swiper-slider swiper-slider-2" id="home" data-loop="true" data-autoplay="false" data-simulate-touch="false" data-slide-effect="fade">
            <div class="swiper-wrapper text-center">
              <div class="swiper-slide context-dark" data-slide-bg="images/slider-9-1920x1328.jpg" style="background-position: 50% 50%">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-lg-center">
                      <div class="col-md-12 col-xl-10">
                        <h1 data-caption-animate="fadeInUp" data-caption-delay="100">The Fastest Way to Send Money Worldwide</h1><a class="button button-lg button-primary" href="#myModal" data-toggle="modal" data-caption-animate="fadeInUp" data-caption-delay="450">Order Card</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-slide context-dark" data-slide-bg="images/slider-10-1920x1280.jpeg">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-lg-center">
                      <div class="col-md-12 col-xl-10">
                        <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Where You Know Your Banker and Your Banker Knows You</h1><a class="button button-lg button-primary" href="#myModal" data-toggle="modal" data-caption-animate="fadeInUp" data-caption-delay="450">Order Card</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-slide context-dark" data-slide-bg="images/slider-8-1920x1328.jpeg" style="background-position: 50% 50%">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-lg-center">
                      <div class="col-md-12 col-xl-10">
                        <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Our Quest to Make Banking Better Starts Here</h1><a class="button button-lg button-primary" href="#myModal" data-toggle="modal" data-caption-animate="fadeInUp" data-caption-delay="450">Order Card</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row row-flex no-gutters">
              ...
              <div class="col-md-6 col-lg-3">
                <div class="blurb-boxed-2 blurb-boxed-darker">
                  ...
                  <p class="exeption">Bank Progress offers various deposits in all international currencies with interest rate up to 25% for all regular clients.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3">
                ...
                <div class="col-md-12 col-lg-4 wow fadeIn">
                  <blockquote class="quote quote-default">
                    ...
                    <div class="quote-body">
                      <q class="heading-6">At Bank Progress, we aim to provide top quality banking services to a greater number of individual and corporate customers than any other bank in the USA or abroad. Our clients value data privacy and security of their banking accounts 24/7.</q>
                    </div>
                    <div class="quote-meta">
                      <div class="author">
                        <cite>Samuel Chapman</cite>
                      </div>
                      <div class="position">CEO &amp; Founder of Bank Progress</div>
                    </div>
                  </blockquote>
                </div>
                  ...
                  <div class="row row-fix row-40">
                    <div class="col-6 col-md-12">
                      <div class="progress-bar-circle-wrap text-center">
                        <div class="progress-bar-circle" data-value="0.5" data-gradient="#1E90FF" data-empty-fill="#fff" data-size="100" data-thickness="2"><span></span></div>
                        <p class="progress-bar-circle-title">Cashback</p>
                      </div>
                    </div>
                    <div class="col-6 col-md-12">
                      <div class="progress-bar-circle-wrap text-center">
                        <div class="progress-bar-circle" data-value="1" data-gradient="#1E90FF" data-empty-fill="#fff" data-size="100" data-thickness="2"><span></span></div>
              ...
              <div class="row no-gutters justify-content-center">
                <div class="col-md-4">
                  <div class="price-box-1">
                    ...
                    <div class="heading-3 price">Free</div><a class="button button-lg button-primary" href="#myModal" data-toggle="modal">Order Now</a>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="price-box-1 price-box-1-primary">
                    ...
                    <div class="heading-3 price">$99.00/mo</div><a class="button button-lg button-primary" href="#myModal" data-toggle="modal">Order Now</a>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="price-box-1">
                    ...
                    <p class="exeption">This card from Bank Progress proved to be a great financial solution for big companies and international enterprises worldwide.</p>
                    <div class="heading-3 price">$199.00/mo</div><a class="button button-lg button-primary" href="#myModal" data-toggle="modal">Order Now</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row row-40 justify-content-center number-counter">
                <div class="col-sm-6 col-lg-3 wow fadeInLeft">
                  <div class="blurb-icon-fill">
                    <div class="icon linearicons-register"><span class="index-counter"></span></div>
                ...
                <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay="0.1s">
                  <div class="blurb-icon-fill">
                    <div class="icon linearicons-menu3"><span class="index-counter"></span></div>
                ...
                <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay="0.2s">
                  <div class="blurb-icon-fill">
                    ...
                    <p class="exeption">This stage concludes the procedure of opening an account at Bank Progress to start using your card.</p>
                  </div>
                </div>
                <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay="0.3s">
                  <div class="blurb-icon-fill">
                    <div class="icon linearicons-credit-card"><span class="index-counter"></span></div>
          ...
          <section class="section section-xs bg-primary-gradient">
            <div class="container">
              <div class="box-cta">
                ...
                <div class="box-cta-inner"><a class="button button-lg button-primary-dark" href="#myModal" data-toggle="modal">Order Card</a></div>
              </div>
            </div>
          </section>
          {/* <!-- Testimonials--> */}
          <section class="section section-lg bg-gray-100" id="testimonials">
            <div class="container text-center">
              <h2>Testimonials</h2>
              {/* <!-- Owl Carousel--> */}
              <div class="owl-carousel text-left" data-items="1" data-md-items="2" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false" data-autoplay="true">
            ...
            <div class="container text-center">
              ...
              <div class="row row-flex row-40 justify-content-center number-counter text-left wow fadeInUp">
                <div class="col-sm-6 col-lg-3">
                  <article class="post-classic-2"><a class="media-wrapper" href="#"><img src="images/masonry-blog-1-370x240.jpg" alt="" width="370" height="240" /></a>
                    <div class="post-meta-main">
                      <div class="post-meta-item">
                        <ul class="list-tags">
                          <li><a class="tag" href="#">News</a>
                          </li>
                        </ul>
                      </div>
                      <div class="post-meta-item">
                ...
                <div class="col-sm-6 col-lg-3">
                  <article class="post-classic-2"><a class="media-wrapper" href="#"><img src="images/masonry-blog-3-370x240.jpg" alt="" width="370" height="240" /></a>
                    <div class="post-meta-main">
                      <div class="post-meta-item">
                        <ul class="list-tags">
                          <li><a class="tag" href="#">News</a>
                      ...
                      <div class="post-meta-item">
                        <div class="post-author"><span>by</span> <a href="#">Lawrence Kelly</a>
                        </div>
                      </div>
                    </div>
                    <h6 class="post-title"><a href="#">Stocks Could Surge Another 10% Between Now And 2019</a></h6>
                ...
                <div class="col-sm-6 col-lg-3">
                  <article class="post-classic-2"><a class="media-wrapper" href="#"><img src="images/masonry-blog-5-370x240.jpg" alt="" width="370" height="240" /></a>
                    <div class="post-meta-main">
                      <div class="post-meta-item">
                        <ul class="list-tags">
                          <li><a class="tag" href="#">News</a>
                      ...
                      <div class="post-meta-item">
                        <div class="post-author"><span>by</span> <a href="#">Theresa Simpson</a>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-sm-6 col-lg-3">
                  <article class="post-classic-2"><a class="media-wrapper" href="#"><img src="images/masonry-blog-2-370x240.jpg" alt="" width="370" height="240" /></a>
                    <div class="post-meta-main">
                      <div class="post-meta-item">
                        <ul class="list-tags">
                          <li><a class="tag" href="#">News</a>
                    ...
                    <h6 class="post-title"><a href="#">Cash Faces a New Challenger in Zelle, a Mobile Banking Service</a></h6>
          ...
          <footer class="section footer-2">
            <div class="container">
              <div class="row row-40">
                <div class="col-md-6 col-lg-3"><a class="footer-logo" href="index.html"><img src="images/logo-105x51.png" alt="" width="105" height="51" /></a>
                ...
                <div class="col-md-6 col-lg-3">
                  ...
                  <ul class="instafeed instagram-gallery" data-lightgallery="group">
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-1-original.jpg"><img src="images/insta-gallery-1-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-2-original.jpg"><img src="images/insta-gallery-2-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-3-original.jpg"><img src="images/insta-gallery-3-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-4-original.jpg"><img src="images/insta-gallery-4-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-5-original.jpg"><img src="images/insta-gallery-5-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                    <li><a class="instagram-item" data-lightgallery="item" href="images/insta-gallery-6-original.jpg"><img src="images/insta-gallery-6-72x72.jpg" alt="" width="72" height="72" /></a>
                    </li>
                  </ul>
                </div>
                <div class="col-md-6 col-lg-3">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Order Card</h4>
